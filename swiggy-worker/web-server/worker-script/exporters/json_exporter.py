...
class Exporter:
    ...
    # JSON only just for transient format for seeder worker to push data to db
    def export_as_json(self, data, flag="menu", restaurantName=None):
        ...
        # This is what most probably will break on parallel request (again use outsource such things)
        if flag == "menu":
